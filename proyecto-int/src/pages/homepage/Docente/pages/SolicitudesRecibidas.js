...
const SOLICITUDES_BASE = [
  ...
  },
  {
    ...
    solicitud: "Tiempo extra en evaluaciones",
    estado: "Aprobada",
  },
  {
    id: "SOL-003",
    ...
    solicitud: "Adecuación de evaluación",
    estado: "Pendiente",
  },
];
...
export default function SolicitudesRecibidas() {
  ...
  const [rows] = useState(SOLICITUDES_BASE);
  ...
  const filtradas = useMemo(() => {
    return rows.filter((r) => {
      const texto =
        `${r.id} ${r.fecha} ${r.estudiante} ${r.carrera} ${r.solicitud} ${r.estado}`.toLowerCase();
  ...
  return (
    <DocenteShell
      ...
      subtitle="Revisión de solicitudes de estudiantes y registro de observación docente."
    >
          ...
          <div className="doc-split">
            <div className="doc-split-left">
              ...
              <p className="doc-note">
                En backend, este módulo debe listar solicitudes por docente/carrera y registrar
                la observación con un PATCH.
              </p>
            </div>
                ...
                {!detalle && (
                  <div className="doc-detail-empty">
                    <p className="doc-muted">
                      Seleccione una fila para ver la solicitud y registrar una observación docente.
                    </p>
                  </div>
                )}
